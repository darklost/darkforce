...
public:
	...
	boost::signals2::signal< void(std::string ip,int64_t port)> sigregister_gate;
	...
	boost::signals2::signal< void(std::string ip,int64_t port)> sigregister_routing;
